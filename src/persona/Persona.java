...
/**
     ...
     * @throws persona.PersonaException
 */    
    public Persona(long dni, String nombre, String apellido, MiCalendario fechaNac) throws PersonaException {
        setDni(dni);
        setNombre(nombre);
 ...
 */
    ...
    public String toString() {
        ...
        return String.format("%8d", dni) + DELIM + // el simbolo de menos es para agregar espacio si el valor no llega a 8 por ejemplo
               String.format("%20s", nombre) + DELIM + 
               String.format("%30s", apellido) + DELIM + 
               fechaNac;
    }                  
